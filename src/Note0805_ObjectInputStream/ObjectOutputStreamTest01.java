...
4、序列化版本号有什么用呢？
    java.io.InvalidClassException:
        ...
        local class incompatible:
            stream classdesc serialVersionUID = -8738112091962810868,(十年后)
            local class serialVersionUID = -4536972319804534042(十年前)
    ...
    都有默认的序列化版本号，他们的序列化版本号不一样。所以区分开了。（这是自动是生成序列化版本号的好处）

    请思考？
       这种自动生成序列化版本号有什么缺陷？
        一旦自动生成的序列化版本号缺点是：一旦代码确定之后，不能进行后续的修改，
