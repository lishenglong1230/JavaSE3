...
public class Account {
    ...
    public void withdraw(double money){
        ...
        线程同步机制的语法是：
            ...
            在java语言中，任何一个对象都有“一把锁”，其实这把锁就是标记。（只要把它叫做锁。）
        ...
        synchronized (this){
        //synchronized (obj){
        //synchronized ("abc"){//"abc"在字符串常量池当中。t1 t2 t3 t4 t5都会同步
        //synchronized (null){//报错：空指针。
        //synchronized (obj2){//这样编写就不安全了，因为obj2不是共享对象，是局部变量。
