...
public class AboutPath {
    public static void main(String[] args) throws Exception{
        ...
        // /F:/bilibiliproject3/out/production/bilibiliproject3/classinfo2.properties
        System.out.println(path);//只有在src下新建才不会发生空指针异常

        //获取db.properties文件的绝对路径(从类的根路径下作为起点开始)
        String path2=Thread.currentThread().getContextClassLoader().getResource("Note0814_Reflect/db.properties").getPath();
